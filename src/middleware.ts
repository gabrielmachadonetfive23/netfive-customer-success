...
const PROTECTED_PATH_PREFIXES = ["/dashboard", "/visitas", "/clientes", "/estatisticas", "/noticias"];
...
export const config = {
  matcher: ["/dashboard/:path*", "/visitas/:path*", "/clientes/:path*", "/estatisticas/:path*", "/noticias/:path*"],
};
